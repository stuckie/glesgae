...
namespace GLESGAE
{
	...
	class InputSystem : public CommonInputSystem, public EventObserver
	{
		public:
			...
			Controller::Id getNumberOfKeyboards() const;

			/// Retreive number of Active Joysticks.
			Controller::Id getNumberOfJoysticks() const;

			/// Retreive number of Active Pads.
			Controller::Id getNumberOfPads() const ;

			/// Retreive number of Active Pointers.
			Controller::Id getNumberOfPointers() const;
